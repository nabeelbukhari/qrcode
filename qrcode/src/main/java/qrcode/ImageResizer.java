...
public class ImageResizer {
     ...
     * Resizes an image to a absolute width and height (the image may not be
     * proportional)
     * @param inputImage Buffered original image
     * @param scaledWidth absolute width in pixels
     * @param scaledHeight absolute height in pixels
     * @throws IOException
     */
    ...
    /**
     * Resizes an image to a absolute width and height percentage (the image may not be
     * proportional)
     * @param inputImage Buffered original image
     * @param percent Resize percentage in double
     * @throws IOException
     */
